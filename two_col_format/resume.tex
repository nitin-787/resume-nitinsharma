...
\namesection{Nitin}{Sharma}{ \urlstyle{same} \href{mailto:nitinsharma.devx@gmail.com}{\faEnvelope \hspace{0.2mm} nitinsharma.devx@gmail.com} | \href{https://github.com/nitin-787}{\faGithub \hspace{0.2mm} Github - nitin-787} | 
...
Codeforces://  \href{https://codeforces.com/profile/Pechkas69}{\bf  Pechkas69}\\

\vspace{4.5mm}
\section{Skills}
\runsubsection{Programming} \\
\textbullet{} Java \textbullet{}   C \textbullet{} C++ \textbullet{} Python \\ \textbullet{} Dart  \\\sectionsep

\runsubsection{Tech Stack} \\
\textbullet{} Android Dev \textbullet{} Web Dev \\ \textbullet{} Flutter \textbullet{} Firebase \textbullet{} Blender \\
\sectionsep

\runsubsection{Dev Tools} \\
...
\location{Jun 12, 2022 – Oct 19, 2022 | \href{https://github.com/MarkisDev/its_urgent} {\faGithub \hspace{0.1mm} Github}}
\vspace{1.5mm}
...
\location{Oct 2022 – Oct 2022 | \href{https://github.com/nitin-787/uni-notes/graphs/contributors} {\faGithub \hspace{0.1mm} Github}} 
\begin{itemize}[leftmargin=*]
...
\location{| Flutter | Firebase | \href{https://github.com/nitin-787/uni-notes/graphs/contributors} {\faGithub \hspace{0.1mm} Github}}
% \vspace{\topsep} 
\begin{itemize}[leftmargin=*]
...
\href{https://github.com/nitin-787/Ayumi-gpt}{\faGithub \hspace{0.1mm} Github}}
% \vspace{\topsep} 
\begin{itemize}[leftmargin=*]
